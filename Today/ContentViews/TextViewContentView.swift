...
class TextViewContentView: UIView, UIContentView {
    ...
    init(_ configuration: UIContentConfiguration) {
        ...
        // assign this content view to be the delegate of the text view control
...
/*
 Objects that you assign as a text view delegate and that conform to the UITextViewDelegate protocol can intervene when the text view detects a user interaction
 */
