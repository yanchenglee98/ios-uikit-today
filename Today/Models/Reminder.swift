...
/*
 #if DEBUG flag is a compilation directive that prevents the enclosed code from compiling when you build the app for release.
 use this flag for testing code in debug builds—or for providing sample test data.
 */
#if DEBUG
extension Reminder {
