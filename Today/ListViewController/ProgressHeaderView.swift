...
//  Today
//
//  Created by Lee Yan Cheng on 16/6/23.
//
...
class ProgressHeaderView: UICollectionReusableView {
    ...
    var progress: CGFloat = 0 {
        didSet {
            ...
            UIView.animate(withDuration: 0.2) { [weak self] in
                self?.layoutIfNeeded() // force the view to update its layout immediately by animating height changes
            }
        }
    }
    ...
    private func prepareSubviews() {
        ...
        // disable automatic specification of view's size and position
